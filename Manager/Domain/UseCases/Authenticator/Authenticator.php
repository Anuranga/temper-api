...
namespace Manager\Domain\UseCases\Authenticator;

use Manager\Domain\Boundary\Repositories\PeopleRepositoryInterface as UserRepository;
use Manager\Domain\Boundary\Globals\Session;
use Manager\Domain\Boundary\Adapters\TokenAdapter;
use Manager\Domain\Boundary\Adapters\HashAdapter;
use Manager\Domain\Entities\User;
use Manager\Domain\Boundary\Repositories\AuthTokenRepositoryInterface as AuthTokenRepository;
use Manager\Adapters\Hash\Bcrypt\BcryptAdapter;
